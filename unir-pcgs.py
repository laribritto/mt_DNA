...
def unir_contigs_pasta(pasta_entrada, pasta_saida):
    ...
    for arquivo_entrada in os.listdir(pasta_entrada):
        if arquivo_entrada.endswith(".fa"):
            ...
            arquivo_saida = os.path.join(pasta_saida, nome_arquivo + "_unido.fasta")
...
# Exemplo de uso
pasta_entrada = "/home/larissabritobiologia/Desktop/ciclideos-novoplasty-anotados/pcgs"
pasta_saida = "/home/larissabritobiologia/Desktop/ciclideos-novoplasty-anotados/pcgs_unicos"
